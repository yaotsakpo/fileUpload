...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\ImportationType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ImportationType']) ? $this->services['AppBundle\Form\ImportationType'] : ($this->services['AppBundle\Form\ImportationType'] = new \AppBundle\Form\ImportationType())) && false ?: '_'};
...
}, 'AppBundle\\Form\\TypeOperationType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\TypeOperationType']) ? $this->services['AppBundle\Form\TypeOperationType'] : ($this->services['AppBundle\Form\TypeOperationType'] = new \AppBundle\Form\TypeOperationType())) && false ?: '_'};
