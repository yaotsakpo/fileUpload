...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'appbundle\\controller\\typeoperationcontroller' => 'AppBundle\\Controller\\TypeOperationController',
            'appbundle\\form\\importationtype' => 'AppBundle\\Form\\ImportationType',
            'appbundle\\form\\produittype' => 'AppBundle\\Form\\ProduitType',
            'appbundle\\form\\typeoperationtype' => 'AppBundle\\Form\\TypeOperationType',
            'creationoperationcaisse' => 'CreationOperationCaisse',
        ...
        $this->fileMap = [
            ...
            'AppBundle\\Controller\\TypeOperationController' => 'getTypeOperationControllerService.php',
            'AppBundle\\Form\\ImportationType' => 'getImportationTypeService.php',
            'AppBundle\\Form\\ProduitType' => 'getProduitTypeService.php',
            'AppBundle\\Form\\TypeOperationType' => 'getTypeOperationTypeService.php',
            'CreationOperationCaisse' => 'getCreationOperationCaisseService.php',
        ...
        $this->privates = [
            ...
            'AppBundle\\Form\\ImportationType' => true,
            'AppBundle\\Form\\ProduitType' => true,
            'AppBundle\\Form\\TypeOperationType' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iCeFxu3jzl', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xO93hN0-70', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hAmNbyiAGQ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pbL3zEPGE6', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lQKfc6SWwZ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('585bdab39428fa457e30c29939e8cc173173f096'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('585bdab39428fa457e30c29939e8cc173173f096');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'fichier_directory': $value = ($this->targetDirs[3].'/web/uploads/'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'secret' => '585bdab39428fa457e30c29939e8cc173173f096',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => '585bdab39428fa457e30c29939e8cc173173f096',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'emmanueltsakpo5@gmail.com' => 'emmanuel',
            ],
